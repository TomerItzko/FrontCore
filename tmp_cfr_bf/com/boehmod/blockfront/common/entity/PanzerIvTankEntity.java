...
public class PanzerIvTankEntity
extends ArtilleryVehicleEntity {
    public BF_693 field_3015;

    public PanzerIvTankEntity(EntityType<? extends PanzerIvTankEntity> entityType, Level level) {
        super((EntityType<? extends ArtilleryVehicleEntity>)entityType, level, (BlockEntityType<? extends BFBlockEntity>)((BlockEntityType)BFBlockEntityTypes.PANZERIV_TANK.get()), ((Block)BFBlocks.PANZERIV_TANK.get()).defaultBlockState(), (BlockEntityType<? extends BFBlockEntity>)((BlockEntityType)BFBlockEntityTypes.PANZERIV_TANK_DESTROYED.get()), ((Block)BFBlocks.PANZERIV_TANK_DESTROYED.get()).defaultBlockState());
    }

    @Override
    @NotNull
    protected BF_624<AbstractVehicleEntity> method_2317() {
        BF_633 bF_633 = new BF_631("turret0", this).method_2441().method_2452(new Vector3f(0.0f, 2.3f, 0.0f)).method_2445(64).method_2464(0);
        BF_623 bF_623 = new BF_623().method_2380().method_2387().method_2393().method_2392().method_2391().method_2382(15.0f, 45.0f).method_2390(new Vector3f(0.0f, 1.55f, 0.0f)).method_2386(new Vector3f(-0.7f, 0.0f, 1.4f)).method_2384("tank_panzeriv_gunner").method_2383(bF_633).method_2385(BF_623.field_2666).method_2389(0.8f);
        BF_633 bF_6332 = new BF_631("turret1", this).method_2444(15.0f, 45.0f).method_2448(BF_632.BULLET).method_2451(BFItems.GUN_MG34).method_2441().method_2445(256).method_2452(new Vector3f(0.0f, 3.0f, -0.2f)).method_2464(1);
        BF_623 bF_6232 = new BF_623().method_2380().method_2393().method_2392().method_2387().method_2391().method_2382(15.0f, 35.0f).method_2390(new Vector3f(-0.7f, 0.6f, 2.6f)).method_2384("tank_sherman_gunner").method_2383(bF_6332).method_2385(BF_623.field_2665).method_2389(0.8f);
    ...
    public BF_693 method_2318() {
        if (this.field_3015 == null) {
            this.field_3015 = new BF_693(this);
        }
