...
public class BF_1218
extends SurrenderPaperParticle {
    protected BF_1218(ClientLevel clientLevel, double d, double d2, double d3, double d4, double d5, double d6, SpriteSet spriteSet) {
        super(clientLevel, d, d2, d3, d4, d5, d6, 0.25f, spriteSet);
    }
    ...
    public static class BF_1219
    implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet field_7058;

        public BF_1219(SpriteSet spriteSet) {
            this.field_7058 = spriteSet;
        }
        ...
        public Particle createParticle(@NotNull SimpleParticleType simpleParticleType, @NotNull ClientLevel clientLevel, double d, double d2, double d3, double d4, double d5, double d6) {
            return new BF_1218(clientLevel, d, d2, d3, d4, d5, d6, this.field_7058);
        }
