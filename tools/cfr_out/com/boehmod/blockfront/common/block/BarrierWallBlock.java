...
public class BarrierWallBlock
extends WallBlock
implements IBarrierBlock {
    private final boolean field_2188;
    private final boolean field_2189;
    @NotNull
    private final IBarrierPredicate predicate;

    public BarrierWallBlock(boolean bl, boolean bl2, @NotNull IBarrierPredicate predicate) {
    ...
    public boolean method_1826(@Nullable Entity entity) {
    ...
    public VoxelShape getShape(@NotNull BlockState blockState, @NotNull BlockGetter blockGetter, @NotNull BlockPos blockPos, @NotNull CollisionContext collisionContext) {
        ...
        if (collisionContext instanceof EntityCollisionContext && this.method_1826((entityCollisionContext = (EntityCollisionContext)collisionContext).getEntity())) {
            return Shapes.empty();
        }
