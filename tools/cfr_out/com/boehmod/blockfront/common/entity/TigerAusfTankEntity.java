...
public class TigerAusfTankEntity
extends ArtilleryVehicleEntity {
    public BF_693 field_3020;

    public TigerAusfTankEntity(EntityType<? extends TigerAusfTankEntity> entityType, Level level) {
        super((EntityType<? extends ArtilleryVehicleEntity>)entityType, level, (BlockEntityType<? extends BFBlockEntity>)((BlockEntityType)BFBlockEntityTypes.TIGER_AUSF_H_TANK.get()), ((Block)BFBlocks.TIGER_AUSF_H_TANK.get()).defaultBlockState(), (BlockEntityType<? extends BFBlockEntity>)((BlockEntityType)BFBlockEntityTypes.TIGER_AUSF_H_TANK.get()), ((Block)BFBlocks.TIGER_AUSF_H_TANK.get()).defaultBlockState());
    }

    @Override
    @NotNull
    protected BF_624<AbstractVehicleEntity> method_2317() {
        BF_633 bF_633 = new BF_631("turret0", this).method_2441().method_2445(64).method_2452(new Vector3f(0.0f, 2.75f, 0.0f)).method_2464(0).method_2466(1);
        BF_623 bF_623 = new BF_623().method_2380().method_2393().method_2392().method_2387().method_2391().method_2383(bF_633).method_2382(15.0f, 45.0f).method_2390(new Vector3f(0.0f, 1.4f, -0.2f)).method_2386(new Vector3f(-0.8f, 0.0f, 2.0f)).method_2384("tank_panzeriv_gunner").method_2385(BF_623.field_2666).method_2389(0.8f);
        Vec3 vec3 = new Vec3(0.0, (double)0.1f, 0.0);
        return new BF_624().method_2408(8.0f).method_2406(true).method_2398(new ArtilleryVehicleControl()).method_2397(64).method_2395(0.025f, 0.015f).method_2409(0.15f, 0.075f).method_2414(0.1f, 0.1f).method_2416(1.85f, 1.85f).method_2420(8.0f).method_2419(1.5f).method_2417(0.75f).method_2399(bF_623).method_2401(bF_633).method_2412().method_2400(new BF_628(ParticleTypes.LARGE_SMOKE, new Vec3((double)-3.95f, (double)2.4f, (double)0.4f)).method_2434(vec3)).method_2400(new BF_628(ParticleTypes.LARGE_SMOKE, new Vec3((double)-3.95f, (double)2.4f, (double)-0.4f)).method_2434(vec3)).method_2400(new BF_630(new Vec3((double)2.2f, (double)0.1f, (double)1.65f)).method_2434(vec3)).method_2400(new BF_630(new Vec3((double)-2.2f, (double)0.1f, (double)1.65f)).method_2434(vec3)).method_2400(new BF_630(new Vec3((double)2.2f, (double)0.1f, (double)-1.65f)).method_2434(vec3)).method_2400(new BF_630(new Vec3((double)-2.2f, (double)0.1f, (double)-1.65f)).method_2434(vec3)).method_2400(new BF_630(new Vec3((double)1.2f, (double)0.1f, (double)1.65f)).method_2434(vec3)).method_2400(new BF_630(new Vec3((double)-1.2f, (double)0.1f, (double)1.65f)).method_2434(vec3)).method_2400(new BF_630(new Vec3((double)1.2f, (double)0.1f, (double)-1.65f)).method_2434(vec3)).method_2400(new BF_630(new Vec3((double)-1.2f, (double)0.1f, (double)-1.65f)).method_2434(vec3));
    }

    @Override
    public BF_693 method_2318() {
        if (this.field_3020 == null) {
            this.field_3020 = new BF_693(this);
        }
