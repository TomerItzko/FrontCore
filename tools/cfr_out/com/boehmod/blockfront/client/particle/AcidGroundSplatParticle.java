...
public class AcidGroundSplatParticle
extends BF_321 {
    protected AcidGroundSplatParticle(@NotNull ClientLevel clientLevel, double d, double d2, double d3, double d4, double d5, double d6, @NotNull SpriteSet spriteSet) {
    ...
    implements ParticleProvider<SimpleParticleType> {
        @NotNull
        private final SpriteSet field_1661;

        public Provider(@NotNull SpriteSet spriteSet) {
            this.field_1661 = spriteSet;
        }
        ...
        public Particle createParticle(@NotNull SimpleParticleType simpleParticleType, @NotNull ClientLevel clientLevel, double d, double d2, double d3, double d4, double d5, double d6) {
            return new AcidGroundSplatParticle(clientLevel, d, d2, d3, d4, d5, d6, this.field_1661);
        }
