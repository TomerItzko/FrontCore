...
public class BulletImpactFlashStrongParticle
extends BF_1133 {
    protected BulletImpactFlashStrongParticle(ClientLevel clientLevel, double d, double d2, double d3, double d4, double d5, double d6, SpriteSet spriteSet) {
    ...
    implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet field_6369;

        public Provider(SpriteSet spriteSet) {
            this.field_6369 = spriteSet;
        }
        ...
        public Particle createParticle(@NotNull SimpleParticleType simpleParticleType, @NotNull ClientLevel clientLevel, double d, double d2, double d3, double d4, double d5, double d6) {
            return new BulletImpactFlashStrongParticle(clientLevel, d, d2, d3, d4, d5, d6, this.field_6369);
        }
