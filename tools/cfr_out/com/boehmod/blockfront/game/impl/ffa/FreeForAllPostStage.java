...
public class FreeForAllPostStage
extends PostGameStage<FreeForAllGame, FreeForAllPlayerManager>
implements TimedStage<FreeForAllGame, FreeForAllPlayerManager> {
    ...
    public void stageStarted(@NotNull FreeForAllGame freeForAllGame, @NotNull FreeForAllPlayerManager freeForAllPlayerManager, @NotNull BFAbstractManager<?, ?, ?> bFAbstractManager, @NotNull PlayerDataHandler<?> playerDataHandler, @NotNull ServerLevel serverLevel, @NotNull Set<UUID> set) {
        super.stageStarted(freeForAllGame, freeForAllPlayerManager, bFAbstractManager, playerDataHandler, serverLevel, set);
        WinningTeamData winningTeamData = freeForAllPlayerManager.getWinningTeam(serverLevel, set, null);
        if (winningTeamData != null) {
            freeForAllGame.finishMatch(serverLevel, bFAbstractManager, BFStats.SCORE, true, winningTeamData, set);
